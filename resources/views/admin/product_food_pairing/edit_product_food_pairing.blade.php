...
@section('content')
                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                    Add Product Food Pairing
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Pair</li>
                                <li><a class="link-effect" href="/admin/food/pairing">All Pairings</a></li>
                            </ol>
                        </div>
                    </div>
            </div>
        ...
        {!! Form::open(['action' => 'FoodPairingController@store', 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t'] ) !!}
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                            <a href="/admin/food/pairing/{{ $item->id }}/edit" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                            {!! Form::open(['action' => ['FoodPairingController@destroy', $item->id ], 'method' => 'POST']) !!}
                                                {{ method_field('DELETE') }}
                                ...
                                @foreach ($pairs as $row)
                                    @if($row->parent == $item->id)
                                     <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                <a href="/admin/food/pairing/{{ $row->id }}/edit" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>

                                                {!! Form::open(['action' => ['FoodPairingController@destroy', $row->id ], 'method' => 'POST']) !!}
                                                {{ method_field('DELETE') }}
                                                <button type="submit" onClick ="return confirm('Are you sure You want to Delete')" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
                                                {!! Form::close() !!}
