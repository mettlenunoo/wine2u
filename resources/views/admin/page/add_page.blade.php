...
@section('content')
            ...
            <main id="main-container">
                ...
                <div class="content animated fadeInLeft">
                 ...
                 {!! Form::open(['action' => 'pageController@store', 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t'] ) !!}
                                        
                     <div class="form-group">
                       <label class="col-xs-12" for="example-text-input">Title</label>
                        <div class="col-sm-12">
                          <input class="form-control" type="text" id="title" name="title" placeholder="Page Title"  required>
                        </div>
                     </div>
