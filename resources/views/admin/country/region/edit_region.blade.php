                        ...
                        <div class="block">    
                            ...
                            <div class="form-horizontal">
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                    <select  class="js-select2 form-control" id="example2-select2"  style="width: 100%;" data-placeholder="Choose many.."    name="parent"  required="">
                                                
                                                        @foreach ($countries as $row)
                                                         <option value="{{$row->id}}" @if( $country->parent == $row->id ) selected  @endif >{{$row->name}}</option>
                                                        @endforeach
                                                    </select>
                                            </div>
                                    </div>           
