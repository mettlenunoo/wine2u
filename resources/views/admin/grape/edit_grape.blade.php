                        ...
                        <div class="col-md-4">
                            ...
                            <div class="block">
                                {{-- <div class="block-header">
                                    <h3 class="title">Add New Product grape</h3>
                                <p> Product categories for your store can be managed here.</p>
                                </div> --}}
          <div class="block-content block-content-narrow">
           {!! Form::open(['action' => ['grapeController@update', $grape->id ], 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t']) !!}
        {{-- {!! Form::open(['action' => 'grapeController@store', 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t'] ) !!} --}}
            <div class="form-group">
                    <div class="col-sm-12">
                        <div class="form-material floating">
                        <input class="form-control" type="text" id="material-text2" name="title" required  value="{{$grape->title}}">
                        ...
                        <div class="form-material floating">
                            <select class="js-select2 form-control" id="material-select2" name="parent" size="1" required>
                                    ...
                                    @foreach ($grapes as $item)
                                       <option  @if($grape->parent == $item->id)   selected  @endif value="{{$item->id}}">{{$item->title}}</option>
                                    @endforeach
                            </select>
                    ...
                    <div class="col-sm-12">
                        <div class="form-material floating">
                            <select class="js-select2 form-control" id="material-select2" name="position" size="1" required> 
                                    ...
                                    @for ($i = 1; $i <= $totalGrapes; $i++)
                                    <option @if($grape->position == $i)   selected  @endif value="{{$i}}">{{$i}}</option>
                                    @endfor
                            </select>
                            <input class="form-control" type="hidden"  name="i" value="{{$grape->id}}">
                    ...
                    <div class="col-sm-12">
                        <div class="form-material floating">
                            <select class="js-select2 form-control" id="material-select2" name="publish" size="1" required>
                                ...
                                <option  @if($grape->publish == "Yes")   selected  @endif value="Yes">Yes</option>
                                <option  @if($grape->publish == "No")   selected  @endif value="No">No</option>
                            </select>
             ...
             <div class="form-group">
                    <div class="col-sm-12">
                            <label for="material-text2">grape Description. If any</label>
                        <div class="form-material floating">
                        <textarea class="form-control" id="example-textarea-input" name="content" rows="6" placeholder="Content..">{{$grape->content}}</textarea>
                        </div>
                    </div>
             </div>
            ...
            <div class="form-group">
                <div class="col-xs-12">
                        ...
                        <a href="/admin/grape" class="btn btn-secondary">Back</a>
                        {{ Form::submit('Update',['class'=>'btn btn-danger'] ) }}

                    {{-- <button class="btn btn-sm btn-primary" type="submit" name="submit">Update grape</button> --}}
                 </div>
            </div>
