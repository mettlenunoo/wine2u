                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Wine</li>
                                <li><a class="link-effect" href="/admin/wine">All Wines</a></li>
                            </ol>
                        </div>
                    </div>
            </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full" id="myTable">
                                ...
                                <tbody>
                                 ...
                                 <tr>   
                                        <td class="text-center">{{ $wine->title }}</td>

                                        <td class="text-center">{{ $wine->slug }}</td>

                                        <td class="text-center">{{ $wine->position }}</td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                            <a href="/admin/wine/{{ $wine->id }}/edit" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                            {!! Form::open(['action' => ['categoryController@destroy', $wine->id ], 'method' => 'POST']) !!}
                                                {{ method_field('DELETE') }}
