                                        ...
                                        {!! Form::open(['action' => 'setupController@store', 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t'] ) !!}
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <div class="form-material floating">
                                                            <input class="form-control" type="number" id="material-text2" name="tax" value="0.00" required step=".01">
                                            ...
                                            <div class="form-group">
                                                <label class="col-xs-12" for="example-file-input">Dashboard Banner</label>
                                                <div class="col-xs-12">
