...
@section('content')
                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Brand</li>
                                <li><a class="link-effect" href="/admin/brand">All Brand</a></li>
                            </ol>
                        </div>
                    </div>
            </div>
        ...
        {!! Form::open(['action' => ['brandController@update', $brand->id ], 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t']) !!}
            <div class="form-group">
                    <div class="col-sm-12">
                        <div class="form-material floating">
                        <input class="form-control" type="text" id="material-text2" name="title" value="{{ $brand->title }}" required >
                    ...
                    <div class="col-sm-12">
                        <div class="form-material floating">
                            <select class="js-select2 form-control" id="material-select2" name="publish" size="1" required>
                                ...
                                <option  @if($brand->publish == "Yes")   selected  @endif value="Yes">Yes</option>
                                <option  @if($brand->publish == "No")   selected  @endif value="No">No</option>
                            </select>
             ...
             <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <div class="form-material floating">
                        <textarea class="form-control" id="example-textarea-input" name="content" rows="6" placeholder="Content..">{{$brand->content}}</textarea>
                        </div>
                    </div>
             </div>
            ...
            <div class="form-group">
                <div class="col-xs-12">
                        <div class="col-xs-12">
                                ...
                                <a href="/admin/brand" class="btn btn-secondary">Back</a>
