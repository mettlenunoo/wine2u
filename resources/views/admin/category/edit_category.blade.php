...
@section('content')
          ...
          <div class="block-content block-content-narrow">
           {!! Form::open(['action' => ['categoryController@update', $category->id ], 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t']) !!}
            <div class="form-group">
             ...
             <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <div class="form-material floating">
                                ...
                                <br>
                        @if($category->image != "")
                        <img src="{{asset('images/'.$category->image)}}" class="thumbimage" >
                        @endif
                        </div>
                    </div>
             </div>
             ...
             <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <div class="form-material floating">
                                <input class="form-control" type="file"  name="bimage" accept="image/*" >
                                <br>
                        @if($category->bimage != "")
                        <img src="{{asset('images/'.$category->bimage)}}" class="thumbimage" >
                        @endif
                        </div>
                    </div>
             </div>
