...
@section('content')
            ...
            <main id="main-container">
                ...
                <div class="content bg-gray-lighter visibility-hidden"   
                data-toggle="appear" data-class="animated bounceIn">
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                {{  ucwords($customer->fname."  ".$customer->lname) }} <small> Orders</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Total </li>
                                <li><a class="link-effect" href="/admin/customer/order/{{ $customer->id }}">{{  count($customer->orders) }} order(s)</a></li>
                            </ol>
                        </div>
                    </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered table-striped js-dataTable-full" data-order='[[ 0, "desc" ]]'>
                                        ...
                                        <tbody>
                                                ...
                                                <?php 
                                               foreach ($customer->orders as $key => $row):
                                                 ?>
