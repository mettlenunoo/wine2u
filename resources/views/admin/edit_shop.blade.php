                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Edit Shop <small>Add new Slide Here, by filling the form below.</small>
                            </h1>
                        </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-material floating">
                                                        <select class="form-control" id="material-select2" name="type" size="1" required>
                                                            <option value="both"  @if($shop->type_0f_shop == "both") selected='selected' @endif >I plan to sell both physical and digital products</option>
                                                            <option value="physical" @if($shop->type_0f_shop == "physical") selected='selected' @endif >I plan to sell physical products</option>
                                                            <option value="virtual" @if($shop->type_0f_shop == "virtual") selected='selected' @endif >I plan to sell digital products</option>
                                                        </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                  ...
                                                  <div id="preview-image">
                                                    <img src="/shop_logos/{{$shop->logo}}" height="50px" width="50px">
                                                  </div>
                                                </div>
                                            </div>
