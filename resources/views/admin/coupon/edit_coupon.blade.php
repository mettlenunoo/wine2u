...
@section('content')
                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Coupon</li>
                                <li><a class="link-effect" href="/admin/coupon">Add a Coupon</a></li>
                            </ol>
                        </div>
                    </div>
            </div>
          ...
          <div class="block-content block-content-narrow">
            {!! Form::open(['action' => ['couponController@update', $coupon->id ], 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t']) !!}            <div class="form-group">
                    <div class="col-sm-12">
                        <div class="form-material floating">
                        <input class="form-control" type="text" id="material-text2" name="title"  value="{{ $coupon->title }}" required >
             ...
             <div class="form-group">
                <div class="col-sm-12">
                    <div class="form-material floating">
                        <input class="form-control" type="text" id="material-text2" name="code" value="{{ $coupon->code }}" required >
                    ...
                    <div class="col-sm-12">
                        <div class="form-material floating">
                            <select class="js-select2 form-control" id="material-select2" name="type" size="1" required>
                                    ...
                                    <option @if($coupon->type == "percentage")  selected @endif  value="percentage">Percentage Off</option>
                                    <option  @if($coupon->type == "free shipping")  selected @endif value="free shipping">Free Shipping</option>
             ...
             <div class="form-group">
                <div class="col-sm-12">
                    <div class="form-material floating">
                        <input class="form-control" type="text" id="material-text2" name="amt" value="{{ $coupon->value }}" required >
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="form-material floating">
                        <input class="form-control" type="text" id="material-text2" name="percentange" value="{{ $coupon->percent_off }}"  required >
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="form-material floating">
                        <input class="form-control" type="number" id="material-text2" name="usage" value="{{ $coupon->usage }}" min="1"  required >
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="form-material floating">
                        <input class="form-control" type="date" id="material-text2" name="valid_date" value="{{ $coupon->valid_date }}"  required >
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <div class="form-material floating">
                        <input class="form-control" type="date" id="material-text2" name="end_date" value="{{ $coupon->end_date }}" required >
                    ...
                    <div class="col-sm-12">
                        <div class="form-material floating">
                            <select class="js-select2 form-control" id="material-select2" name="status" size="1" required>
                                ...
                                <option @if($coupon->status == "Yes")  selected @endif value="Yes">Yes</option>
                                <option @if($coupon->status == "No")  selected @endif value="No">No</option>
                            </select>
             ...
             <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <div class="form-material floating">
                        <textarea class="form-control" id="example-textarea-input" name="content" rows="6" placeholder="Content.."> {{ $coupon->details }}</textarea>
                        </div>
                    </div>
             </div>
             ...
             <div class="form-group">
                <div class="col-xs-12">
                        <div class="col-xs-12">
                                ...
                                <a href="/admin/coupon" class="btn btn-secondary">Back</a>
