            ...
            <div class="row">
               <div class="col-6 col-md-4 col-lg-3">
                  <div class="input-group mb-3">
                     <div class="input-group-prepend">
                        <button class="btn btn-dark-product" id="minus-btn"><i class="fa fa-minus"></i></button>
                     </div>
                     
                        <input type="number" id="qty_input" class="form-control form-prod text-center" value="1" min="1" max="{{ $product->variableProductAttributes[0]->quantity }}" >
                        <input type="hidden" value="{{ $product->variableProductAttributes[0]->id }}" id="vproductId">
                     <div class="input-group-prepend">
                        <button class="btn btn-dark-product2" id="plus-btn"><i class="fa fa-plus"></i></button>
                     </div>
                  </div>
               </div>
               ...
               @if(auth('customer')->user())
                  <div class="col-2 col-md-2 col-lg-2">
                     ...
                     <button class="btn btn-prod2 px-4 wishlist" @if(count($wishList) == 1) style="background:rgb(228 196 156)" @endif><img src="/page_assets/img/bx_bx-bookmark-plus.svg" alt=""></button>
         ...
         <div class="col-12 col-md-6 pr-md-5" >
            ...
            <div class="row mt-5 ">
               <div class="col-12 mb-3">
                  ...
                  <input type="range" class="custom-range" min="0" max="10" value="{{ $product->light }}" id="lightBold">
               </div>
               <div class="col-12 mb-3">
                  ...
                  <input type="range" class="custom-range" min="0" max="10" value="{{ $product->smooth }}" id="SmoothTannic">
               </div>
               <div class="col-12 mb-3">
                  ...
                  <input type="range" class="custom-range" min="0" max="10" value="{{ $product->dry }}" id="drySweet">
               </div>
               <div class="col-12 mb-3">
                  ...
                  <input type="range" class="custom-range" min="0" max="10" value="{{ $product->soft }}" id="oftAcidic">
               </div>
            </div>
         </div>
         <div class="col-12 col-md-6">
            ...
            @if(count($product->pairing) > 0)
               <div class="row my-5 relativetins">
                  ...
                  <div class="col-12 prodslidearrow">
                     <ul class="list-inline d-flex justify-content-between">
                        <li class="list-inline-item px-2"><img src="/page_assets/img/leftarrow.svg" alt="" href="#paringcarouselExampleControls" data-slide="prev" ></li>
                        <li class="list-inline-item px-2"><img src="/page_assets/img/rightarrow.svg" alt="" href="#paringcarouselExampleControls" data-slide="next"></li>
                     </ul>
                  </div>
               </div>
            @endif
                  ...
                  <div class="bd-highlight px-2 pt-2">
                     {{-- <div class="mr-auto p-2 bd-highlight  product-small ">{{ $similarProduct->review_summary->average_rating }}</div> --}}
                        ...
                        <div class="rating">
                           ...
                           <input type="radio" name="rating-{{ $similarProduct->id }}" value="4" id="4-{{ $similarProduct->id }}" @if($similarProduct->review_summary->average_rating >= 4 && $similarProduct->review_summary->average_rating < 5  ) checked @endif>
                           <label for="4-{{ $similarProduct->id }}">☆</label>
                           <input type="radio" name="rating-{{ $similarProduct->id }}" value="3" id="3-{{ $similarProduct->id }}" @if($similarProduct->review_summary->average_rating >= 3 && $similarProduct->review_summary->average_rating < 4) checked @endif>
                           <label for="3-{{ $similarProduct->id }}">☆</label>
                           <input type="radio" name="rating-{{ $similarProduct->id }}" value="2" id="2-{{ $similarProduct->id }}" @if($similarProduct->review_summary->average_rating >= 2 && $similarProduct->review_summary->average_rating < 3) checked @endif >
     ...
     <div class="modal-content">
       ...
       <form id="addRate">
         <div class="media centerit">
               ...
               @else
                  <img src="/user_pic/{{ auth('customer')->user()->user_profile_image }}" class=" reviewimage" alt="{{ auth('customer')->user()->fname." ".auth('customer')->user()->lname }}">
               @endif

               <div class="media-body pl-2">
                  <p class="mb-0"><strong>{{ auth('customer')->user()->fname." ".auth('customer')->user()->lname }}</strong> </p>
                  <ul class="list-inline">
                     <li class="list-inline-item">
                        <div class="rating"> 

                           <input type="radio" name="rate" value="5" id="rating51" @if($review->rating == 5) checked @endif >
                           <label for="rating51">☆</label>
                           <input type="radio" name="rate" value="4" id="rating41" @if($review->rating >= 4 && $review->rating < 5  ) checked @endif>
                           <label for="rating51">☆</label>
                           <input type="radio" name="rate" value="3" id="rating31" @if($review->rating >= 3 && $review->rating < 4) checked @endif>
                           <label for="rating51">☆</label>
                           <input type="radio" name="rate" value="2" id="rating21" @if($review->rating >= 2 && $review->rating < 3) checked @endif >
                           <label for="rating51">☆</label>
                           <input type="radio" name="rate" value="1" id="rating11" @if($review->rating > 0  && $review->rating < 2) checked @endif>
                           <label for="rating51">☆</label>
       ...
       <textarea class="form-control"  id="rate_comment" rows="5" placeholder="Say something about the wine">{{ $review->comment }}</textarea>
       </div>
       ...
       function wishListToggle(){
         ...
         var toggle = $('.wishlistproduct').val();
           ...
           $.ajax({
               url:"/wishlist",
               method:"POST",
               data:{productId:productId, toggle:toggle},
               success:function(data){
