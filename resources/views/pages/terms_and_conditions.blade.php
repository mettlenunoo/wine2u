...
<head>
    <title>Wine2u | Privacy & Policy</title>
    <meta charset="utf-8">
        ...
        <div class="container  ">
            <div class="row">
                <div class="col-12 col-md-7 mx-auto text-center mt-20">
                    ...
                    <p>Welcome to www.wine2u.com!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of Wine2u's Website,
                        located at www.wine2u.com.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        www.wine2u.com if you do not agree to take all of the terms and conditions stated on this page.
                    </p>
                    ...
                    <p>We employ the use of cookies. By accessing www.wine2u.com, you agreed to use cookies in agreement
                        with the Wine2u's Privacy Policy. </p>
                    ...
                    <p>Unless otherwise stated, Wine2u and/or its licensors own the intellectual property rights for all
                        material on www.wine2u.com. All intellectual property rights are reserved. You may access this
                        from www.wine2u.com for your own personal use subjected to restrictions set in these terms and
                        conditions.</p>

                    <p>You must not:</p>
                    <ul class="text-left">
                        <li>Republish material from www.wine2u.com</li>
                        <li>Sell, rent or sub-license material from www.wine2u.com</li>
                        <li>Reproduce, duplicate or copy material from www.wine2u.com</li>
                        <li>Redistribute content from www.wine2u.com</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. Wine2u does not filter, edit, publish or review
                        Comments prior to their presence on the website. Comments do not reflect the views and opinions
                        of Wine2u,its agents and/or affiliates. Comments reflect the views and opinions of the person
                        who post their views and opinions. To the extent permitted by applicable laws, Wine2u shall not
                    ...
                    <p>Wine2u reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    <p>You hereby grant Wine2u a non-exclusive license to use, reproduce, edit and authorize others to
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of Wine2u; and (d) the link is in the context of general
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to Wine2u. Please include your name, your
                    ...
                    <p>No use of Wine2u's logo or other artwork will be allowed for linking absent a trademark license
                        agreement.</p>
                    ...
                    {{-- <a href="\index"><button>CONTINUE SHOPPING <span class="pl-2 text-right"><img src="{{ asset('img/icons/arrorright.svg')}}"
                    width="8" alt=""></span></button></a>
                    --}}
                </div>
            </div>
        </div>
