...
<section class="profile-top ">
 ...
 <!-- loyalty Points -->
      <div class="tab-pane fade" id="list-Loyalty-Points" role="tabpanel" aria-labelledby="list-Loyalty-Points-list">
      <h1 class="profilet1 mb-5">Loyalty Points</h1>

      <div class="row">
        <div class="col-12 col-md-6 mx-auto text-center">
          <h1  class="profilet2">Share With Friends And Earn</h1>

          <div class="mt-5">
            <small>Points you’ve earned so far</small>
            <p class="points-titile  wine2upc mb-0"> {{ number_format($profile->referral_amount,2) }} </p>
            <p class="text-uppercase points-text">Points</p>

           <p class="muted mb-5">Invite a friend or share your referral code <br>
with friends and family earn points.</p> 

            <img src="/page_assets/img/twitterpp.svg" alt="" class="pr-2"> 
            <img src="/page_assets/img/facebookppp.svg" alt="" class="pr-2">
            <img src="/page_assets/img/linkpp.svg" alt="" class="pr-2">
            <img src="/page_assets/img/whatsapp.svg" alt="" class="pr-2">
            <img src="/page_assets/img/IGppp.svg" alt="" class="pr-2">


          </div>
          
          <div class="my-5">
          <button type="submit" class="btn  btn-wine2u-deep px-5 mx-2  "> {{ $profile->referral_code }} </button>
          <button type="submit" class="btn copy-link "> <img src="/page_assets/img/copyicon.svg" alt=""> </button>
          </div>
...
<!-- Preferences -->
      ...
      <h1 class="profilet1 mb-5">Preferences</h1>
      <div class="row">
        <div class=" col-12 col-md-8">

             <div class="row">
                  <div class="col-9">
                  <p class="mb-1 font-weight-bold"> Lorem ipsum dolor sit amet, consectetur </p>
             <p >  <small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi consequat sagittis, mattis viverra et phasellus duis id. Sit nunc eleifend turpis pretium lacus lacus, a orci in.</small>  </p>
                  </div>
...
<!-- Order History -->
      <div class="tab-pane fade" id="list-Order-History" role="tabpanel" aria-labelledby="list-Order-History">
      ...
      <table class="table table-hover ">
                  <thead>
                    <!-- <tr>
                      <th scope="col">Order No. / Address</th>
...
{{-- 
                  <td scope="row"> 
                        <strong>Order no. 133V3RE44 </strong>
                      <p><small>2118 Thornridge Cir. Syracuse, Connecticut 35624</small></p>
                      </td>
                      <td>12-04-2020</td>
                      <td>GHC 200</td>
                      <td><a href="#"> <small>View details</small> </a></td>
                    </tr>
