        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="panel panel-1">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                           <label for="inputState">Country *</label>
                           <select id="ship_input" class="custom-select form-control form-control2"  name="" onchange="shiprate(this);" required>
                     ...
                     <div class="form-group col-md-12">
                       <label for="inputCity">State / Region * </label>
                       {{-- @if($shop->country == "INT" || $shop->country == "int" )

                       <input type="text" class="form-control form-control2" name="shipstate" required >

                       @elseif($shop->country == "GB" || $shop->country == "gb")

                       <select  name="shipstate" class="custom-select  form-control form-control2"  required>
                           <option value="">Choose...</option>
                           @foreach ($countries as $item)
                       ...
                       <select id="ship_input" class="custom-select  form-control form-control2"  onchange="shiprate(this);" required>
                           <option value="">Choose...</option>
                           @foreach ($countries as $item)
                           <option value="{{ $item->zone }}">{{ $item->country }}</option>
                           @endforeach
               ...
               {{-- 
                 <div class="form-group col-md-6">
                     <label for="">Shipping
                         <input type="checkbox" class="form-control form-control2" name="lastname2" >
                     </label>
                 </div> --}}
                 ...
                 {{-- @php 
                     ...
                     $nextDayShipmet = 0.0;
                     if($shop->country == "GB" || $shop->country == "gb"){
                     $nextDayShipmet = 9.50;
                 }elseif($shop->country == "US" || $shop->country == "us" ){
                 $nextDayShipmet = 14.99;
             }

             @endphp --}}

             {{--                                  
                 @if($shop->country == "GB" || $shop->country == "gb" || $shop->country == "US" || $shop->country == "us")

                 <div class="custom-control custom-radio custom-control-inline">
                   <input type="radio" id="shipment" name="shipment" class="custom-control-input" onclick="nextDayshipmet(0)" value="0" required checked>
                   <label class="custom-control-label" for="shipment">Normal Rate</label>
               </div>

               <div class="custom-control custom-radio custom-control-inline">
                   <input type="radio" id="Nextshipment" name="shipment" class="custom-control-input" onclick="nextDayshipmet({{ $nextDayShipmet }})" value="{{ $nextDayShipmet }}" required>
                   <label class="custom-control-label" for="Nextshipment">Next day shipping {{ strtoupper($shop->currency) }} {{ $nextDayShipmet }}</label>
               </div>
...
<div class="col-12">
  <div class="panel">
    <div class="panel-body ">
       ...
       <div class="form-group col-12 fifteenp">
         <label for="inputCity"> </label>
         <button type="submit" class="conf" >Submit</button>
     </div>
 </div>
</div>
</div>
