...
<html lang="en">
    ...
    @if(empty($activeCategory->image))

     <div class="top-section" style="background-image: url(/img/default_img.jpg);" >

    @else

     <div class="top-section" style="background-image: url(/images/{{ $activeCategory->image }});" >
      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-8 col-sm-8 col-xs-12 col-lg-offset-3 col-md-offset-2 col-sm-offset-2 text-center" style="color:#ffffff;">
                   ...
                   <h3>{{ strtoupper($activeCategory->title)   }}</h3>
                   <p>{{ strtoupper($activeCategory->content) }} </p>
                   <br>
              ...
              <div class="col-lg-12 clearfix" style="margin-bottom: 20px;">
                ...
                <div class="dropdown pull-left contains-button" style="padding-right: 5px;">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      ...
                      <a href="/{{ strtolower($shop->country) }}/store/{{ strtolower($activeCategory->slug) }}?sort=latest" class="dropdown-item" >Lastest</a>
                      <a href="/{{ strtolower($shop->country) }}/store/{{ strtolower($activeCategory->slug) }}?sort=low" class="dropdown-item" >Low</a>
                      <a href="/{{ strtolower($shop->country) }}/store/{{ strtolower($activeCategory->slug) }}?sort=high" class="dropdown-item" >High</a>
               ...
               @if(count($products) > 0)
                  ...
                  @foreach ($products as $product)
                      ...
                      <div class="products col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="panel">  
