...
<html lang="en">
    ...
    @else
     ...
     <div class="top-section" style="background-image: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3) ),url('images/'{{ $selectCategory->image}} );" >
    ...
    @endif --}}
      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-2 col-sm-offset-2 text-center" style="color:#ffffff;">
            ...
            <div class="row">
              ...
              @else
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <h4 class="pull-left">Search no found.<br/>Please Try again. Thank you!. </h4>
