...
<?php require_once("includes/function.php");?>
    ...
    if(isset($_POST['submit'])){              
            // source http://www.mysqltutorial.org/php-querying-data-from-mysql-table/
                    ...
                    // SET PARAMETERS
                    $q->bindParam(':username', $usern);
                    $q->bindParam(':hashed_password', $hashed_password);
               ...
               while ($row = $q->fetch()):
                ...
                if($row['status'] == "block"){
                 ...
                 $message = "Please you are blocked. Contact your administrator."; 
                ...
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="block block-themed animated bounceIn">
                        ...
                        <div class="block-content block-content-full block-content-narrow">
                            <!-- Login Title -->
                            <h1 class="h2 font-w600 push-30-t push-5">  HAUTE VIE</h1>
                            <p>Welcome, please login.</p>
                            <p style="color:red; font-weight: bold;"><?php echo $message;?></p>
                           
                            <form class="form-horizontal push-30-t push-50" action="login_user.php" method="post">
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="form-material form-material-primary floating">
                                            <input class="form-control" type="text" id="" name="username"value="<?php echo $usern;?>"  required >
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <button class="btn btn-block btn-primary" type="submit" name="submit"><i class="si si-login pull-right"></i> Log in</button>
                                    </div>
                                </div>
                            </form>
                            <!-- END Login Form -->
